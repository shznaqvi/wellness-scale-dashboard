...
<body>
    ...
    <i class="fas fa-chart-pie fa-sm text-gray-400 mr-2 ml-4"></i>
          ...
          <div class="container-fluid ">
		   <div class="row mb-4 ">
        <h1 class="text-center mb-4">Family Member Details</h1>
        <div class="card table-responsive">
          <table id="familyTable" class="table table-sm table-bordered table-striped">
    <thead>
        <tr>
            <th>Member Name</th>
            <th>Age</th>
  ...
  <th>Mental Health</th>
    ...
    <tbody>
        <!-- Data will be inserted by DataTables via AJAX -->
    </tbody>
</table>
        </div>
        <div class="text-center mt-4">
            <a href="daily_activity.php" class="btn btn-primary">Back to LHW forms</a>
        </div>
    </div>
	</div>
 ...
 pageLength: 50
    ...
    $(document).ready(function() {
        $('#familyTable').DataTable({
            "ajax": {
 "url": "ajax/get_family_members.php?uid=<?php echo urlencode($_GET['uid']); ?>",
 "type": "GET",
                "dataSrc": ""
            },
			 "pageLength": 50,
